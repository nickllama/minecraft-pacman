...
// Classic PacMan-style maze. Legend:
// # wall, . carrot, o golden apple, space empty, P Steve spawn, Z zombie spawn, - ghost house door
const RAW_MAP = [
  "############################",
  "#............##............#",
  "#.####.#####.##.#####.####.#",
...
function updateZombies() {
  for (const z of zombies) {
    if (z.dead) {
      // respawn at center
      z.x = 13; z.y = 14; z.px = z.x*CELL; z.py = z.y*CELL;
